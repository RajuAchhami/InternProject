...
const OurServices = () => {
  ...
  const Card = ({ item }) => {
    return (
      <div
        className={`cursor-pointer relative items-center justify-center  h-[400px] md:h-[500px] flex   w-[420px]  `}
      >
        <div
          className=" size-36 md:size-40 lg:size-48 rounded-full z-50
         bg-[#7a6ad8] absolute right-0 md:right-1 lg:right-3 xl:-right-9 top-0 lg:-top-12 xl:top-0 flex items-center justify-center "
        >
          <img src={item.icon} className={`hover:-translate-y-2`} />
        </div>
        <div className="rounded-2xl bg-[#f1f0fe] flex flex-col gap-6 px-7 pt-16 pb-10 w-80 md:max-w-64 lg:max-w-52 xl:max-w-80">
  ...
  return (
    <div className="container ">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 place-items-center lg:place-content-center gap-7 ">
